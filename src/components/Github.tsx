...
export default function Github() {
    return (
        <a href="https://github.com/fatihdelice/word-count-analyzer" target="_blank" id="github" aria-label="View source on GitHub"><svg id="github" width="80" height="80" viewBox="0 0 250 250" aria-hidden="true">
